  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col">
      ...
      <div className="flex flex-col gap-8 px-6 pt-6">
        {/* 이미지 */}
        <label className="relative w-full h-[152px] cursor-pointer">
          {src ? (
            <img
              src={src}
              alt="여행 이미지"
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/45 rounded-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="w-full bg-neutral rounded-10 px-3 py-2 text-14-rg text-black1 outline-none"
          />
        </div>
      </div>
    </div>
