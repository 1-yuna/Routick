    ...
    <div className="pt-12 pb-32 flex flex-col h-screen bg-white">
      ...
      <div className="flex flex-col px-6 py-12 gap-14">
        ...
        >
          ...
          <RightIcon className="w-4 h-4 text-gray2" />
        </div>

        {/*계정*/}
        <div className="flex flex-col gap-5">
          <p className="text-12-rg text-gray2">계정</p>
          <div className="flex flex-col gap-2">
            <div className="flex justify-between">
              <p className="text-14-rg text-black1">계정 타입</p>
              <p className="text-14-rg text-gray2">{user.accountType}</p>
            </div>
            <button
              className="text-left text-14-rg text-error"
